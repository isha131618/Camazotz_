...
const PatientDischargeForm = () => {
  ...
  const fetchPatientData = async () => {
    try {
      ...
      setValue('patientName', `${patientData.firstName} ${patientData.lastName}`);
      setValue('patientId', patientData._id);
      setValue('patientContactInfo.address', `${patientData.address.street}, ${patientData.address.city}, ${patientData.address.state} ${patientData.address.zipCode}`);
      setValue('patientContactInfo.phone', patientData.phone);
      setValue('patientContactInfo.email', patientData.email);
    } catch (error) {
