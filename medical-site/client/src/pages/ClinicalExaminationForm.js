...
const ClinicalExaminationForm = () => {
  ...
  const handleAIData = (structuredData) => {
              ...
              <MedicalFormGrid columns={4}>
                <MedicalFormField label="Blood Pressure">
                  <input
                    ...
                    onFocus={() => setFocusedField('vitalSigns.bloodPressure')}
                ...
                <MedicalFormField label="Heart Rate">
                  <input
                    ...
                    onFocus={() => setFocusedField('vitalSigns.heartRate')}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    placeholder="72 bpm"
                  />
                </MedicalFormField>
                <MedicalFormField label="Respiratory Rate">
                  <input
                    ...
                    onFocus={() => setFocusedField('vitalSigns.respiratoryRate')}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <MedicalFormField label="Temperature">
                  <input
                    ...
                    onFocus={() => setFocusedField('vitalSigns.temperature')}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    placeholder="98.6°F"
                  />
                </MedicalFormField>
                <MedicalFormField label="Oxygen Saturation">
                  <input
                    ...
                    onFocus={() => setFocusedField('vitalSigns.oxygenSaturation')}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    placeholder="98%"
                  />
                </MedicalFormField>
                <MedicalFormField label="Height">
                  <input
                    ...
                    onFocus={() => setFocusedField('vitalSigns.height')}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    placeholder="5'10&quot;"
                  />
                </MedicalFormField>
                <MedicalFormField label="Weight">
                  <input
                    ...
                    onFocus={() => setFocusedField('vitalSigns.weight')}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    placeholder="170 lbs"
                  />
                </MedicalFormField>
                <MedicalFormField label="BMI">
                  <input
                    ...
                    onFocus={() => setFocusedField('vitalSigns.bmi')}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    placeholder="24.4"
                  />
                </MedicalFormField>
              ...
              <MedicalFormGrid columns={2}>
                <MedicalFormField label="Consciousness">
                  <select
                    ...
                    onFocus={() => setFocusedField('generalAppearance.consciousness')}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  >
                ...
                <MedicalFormField label="Distress Level">
                  <select
                    ...
                    onFocus={() => setFocusedField('generalAppearance.distress')}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  >
                    <option value="">Select...</option>
              ...
              >
                <div className="relative">
                  <textarea
                    ...
                    onFocus={() => setFocusedField('generalAppearance.notes')}
                    rows={4}
                  ...
                  <AIVoiceToText 
                    mode="raw"
                    onTranscript={(text) => setValue('generalAppearance.notes', text)}
            ...
            <MedicalFormSection title="Assessment and Plan">
              ...
              >
                <div className="relative">
                  ...
                  <AIVoiceToText 
                    mode="raw"
                    onTranscript={(text) => setValue('assessment', text)}
              ...
              >
                <div className="relative">
                  ...
                  <AIVoiceToText 
                    mode="raw"
                    onTranscript={(text) => setValue('plan', text)}
                    formType="diagnosis-treatment"
